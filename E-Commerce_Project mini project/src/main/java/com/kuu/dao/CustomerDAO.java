...
public class CustomerDAO {
	...
	public boolean addCustomer(Customer customer) {
		...
		try {
			...
			String sql = "insert into customer(first_name,last_name,password,address,city,state,email,phone) values(?,?,?,?,?,?,?,?)";
...
public boolean updateCustomer(Customer customer) {
		...
		try {
			...
			String sql = "update customer set first_name=?,last_name=?,password=?,address=?,city=?,state=?,email=?,phone=? where id = ?";
