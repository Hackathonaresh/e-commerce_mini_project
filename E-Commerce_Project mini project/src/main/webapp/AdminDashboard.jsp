...
<body>
    <header>
      <nav class="navbar">
        ...
        <div class="sign-in">
         <a href="add_customer.jsp"> <p>Hello, sign in</p>
          <span>Account &amp; Lists</span></a>
        </div>
		
		<div class="sign-in">
         <a href="fetch.jsp"> <p>Fetch Data</p>
          <span>of All Clients</span></a>
        </div> 	
        <div class="sign-in">
         <a href="Adminfetch.jsp"> <p>Fetch Data</p>
          <span>of All Admins</span></a>
        </div> 	
